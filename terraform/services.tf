...
locals {
  ...
  signing_config = {
    CERTIFICATE_SIGNING_KEY = data.google_kms_crypto_key_version.certificate-signer-version.id
    TOKEN_SIGNING_KEY       = data.google_kms_crypto_key_version.token-signer-version.id
  }
}
