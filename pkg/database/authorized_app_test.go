...
func TestCreateFindAPIKey(t *testing.T) {
	...
	authApp, err := db.CreateAuthorizedApp("University System Health Org", false)
	if err != nil {
...
func TestListAPIKeys(t *testing.T) {
	...
	authApp1, err = db.CreateAuthorizedApp("App 1", true)
	if err != nil {
		t.Fatalf("error creating app: %v", err)
	}
	authApp2, err = db.CreateAuthorizedApp("App 2", false)
	if err != nil {
		t.Fatalf("error creating app: %v", err)
	}
