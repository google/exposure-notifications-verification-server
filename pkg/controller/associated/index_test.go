...
func TestIndex(t *testing.T) {
	...
	t.Run("well-known_root_404", func(t *testing.T) {
		...
		req, err := http.NewRequestWithContext(ctx, http.MethodGet, srv.URL+"/.well-known", nil)
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("well-known_apple-app-site-association_missing_region", func(t *testing.T) {
		...
		req, err := http.NewRequestWithContext(ctx, http.MethodGet, srv.URL+"/.well-known/apple-app-site-association", nil)
		if err != nil {
			t.Fatal(err)
		}
		resp, err := client.Do(req)
	...
	t.Run("well-known_assetlinksjson_missing_region", func(t *testing.T) {
		...
		req, err := http.NewRequestWithContext(ctx, http.MethodGet, srv.URL+"/.well-known/assetlinks.json", nil)
		if err != nil {
			t.Fatal(err)
		}
		resp, err := client.Do(req)
